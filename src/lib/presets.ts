  ...
  days: [
    day('Push 1', UPPER_WARMUP, [
      ...
      ex('Pec Stretch', 2, 30, 30, 90, body(),
        'Log the hold in seconds. Closes the Press-Around superset; rest after this one.'),
      ...
      ex('Stretch-Only Overhead Triceps Extension', 3, 8, 8, 90, iso('cable'),
        'Stretched half only. Closes the Squeeze-Only Triceps Pressdown superset; rest after this one.'),
    ...
    day('Pull 1', UPPER_WARMUP, [
      ...
      ex('Bottom-Half Dumbbell Pullover', 2, 10, 12, 30, iso('dumbbell'),
        'Stretched half only. Superset with Lat Stretch; move straight into it.'),
      ex('Lat Stretch', 2, 30, 30, 30, body(),
        'Log the hold in seconds, per side. Closes the Bottom-Half Dumbbell Pullover superset; rest, then repeat the pair.'),
